...
@pytest.mark.parametrize("modulename,is_package,mapping,result", [
    ["demo", False, {"dem": "abc"}, None],
    ["demo", False, {"demo": "https://github.com/mhils/pdoc/blob/master/test/snapshots/demo"},
     "https://github.com/mhils/pdoc/blob/master/test/snapshots/demo.py"],
    ["demo", True, {"demo": "https://github.com/mhils/pdoc/blob/master/test/snapshots/demo/"},
     "https://github.com/mhils/pdoc/blob/master/test/snapshots/demo/__init__.py"]
])
def test_edit_url(modulename: str, is_package: bool, mapping: Mapping[str, str], result: Optional[str]):
    assert edit_url(modulename, is_package, mapping) == result


@pytest.mark.parametrize("all_modules,fullname,result", [
